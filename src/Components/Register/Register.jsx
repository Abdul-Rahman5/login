...
export default function Register() {
    ...
    return (
        <div className="row m-0 m-lg-5 login-form">
                        ...
                        <form className='my-4' onSubmit={submitRegistrationForm}>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <input onChange={getUserData} type="text" className="form-control mt-3" name="first_name" id="first_name" placeholder="First Name" />
                                ...
                                <div className="col-md-6">
                                    <input onChange={getUserData} type="text" className="form-control mt-3" name="last_name" id="last_name" placeholder="Last Name" />
                            ...
                            <input onChange={getUserData} type="email" className="form-control py-2 mt-3" name="email" id="email" placeholder="Email Address" />
                            ...
                            <input onChange={getUserData} type="number" className="form-control py-2 mt-3" name="age" id="email" placeholder="Age" />
                            ...
                            <input onChange={getUserData} type="password" className="form-control py-2 mt-3" name="password" id="password" placeholder="Password" />

                            {errorList.filter((err) => err.context.label === 'password')[0] ? <div className="alert alert-warning mb-0 mt-1 fs-6 p-1">
                                <p className="m-0">Password do not match</p>
                            </div> : ''}
